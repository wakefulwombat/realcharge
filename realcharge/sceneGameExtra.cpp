...
SceneGameExtra::SceneGameExtra(ISetNextScene* changer, int selectedMode, bool doesStartFromBoss, ISetGameClearData* isetGameClearData, ISetDifficulty* isetDifficulty){
	...
	if (selectedMode == 0){//explode
		...
		this->bossManage = new BossManage(this->selifBoxManage, this->textEffectManage, this->enemyBulletManage, this->enemyBulletManage, this->enemyBulletManage, this->itemManage, this->player, this, this, this->burnEffectManage, 0);
		this->board = new Board(this->player, this->bossManage, this->bossManage, 0);
		if (doesStartFromBoss == true) this->enemyManage = new EnemyManage(this->barrageManage, this->itemManage, this->player, this->board, this->bossManage, this->bossManage, this->enemyBulletManage, this->burnEffectManage, this->backEffectManage, 7);
		...
		this->scenePlayerDead = new ScenePlayerDead(changer, isetDifficulty, this->backEffectManage, this->bossManage, isetGameClearData);
		this->scenePause = new ScenePause(changer, isetDifficulty, this, this->backEffectManage, this->bossManage, isetGameClearData, true);

		this->enemyBulletManage->initialize(this->burnEffectManage, this->shockWaveManage, this->player, this->bossManage, this->bossManage);
		this->player->initialize(this->numericalBarManage, this->itemManage, this->enemyBulletManage, this->bossManage, this->shockWaveManage, this->bombManage, 1, false);
	}
		...
		this->enemyBulletManage = new EnemyBulletManageEX();
		this->barrageManage = new BarrageManage(this->enemyBulletManage, this->player, this->enemyBulletManage);
		this->bossManage = new BossManage(this->selifBoxManage, this->textEffectManage, this->enemyBulletManage, this->enemyBulletManage, this->enemyBulletManage, this->itemManage, this->player, this, this, this->burnEffectManage, 1);
		...
		this->enemyBulletManage->initialize(this->burnEffectManage, this->shockWaveManage, this->player, this->bossManage, this->bossManage);
		this->player->initialize(this->numericalBarManage, this->itemManage, this->enemyBulletManage, this->bossManage, this->playerBulletManage, this->enemyBulletManage, 1, false);
	}
	else{//absorb
		this->itemManage = new ItemManage();
		this->burnEffectManage = new BurnEffectManage(1);
		...
		this->enemyBulletManage->initialize(this->burnEffectManage, this->shockWaveManage, this->player, this->bossManage, this->bossManage);
		this->player->initialize(this->numericalBarManage, this->itemManage, this->enemyBulletManage, this->bossManage, this->shockWaveManage, this->collapsarManage, 1, false);
	}
}

void SceneGameExtra::initialize(){
...
void SceneGameExtra::loadEnemyCSV(){
	char filepath[64];

	sprintf_s(filepath, "material\\enemyCSV\\e7.csv");
...
void SceneGameExtra::loadBarrageCSV(){
	char filepath[64];
	sprintf_s(filepath, "material\\barrageCSV\\b7.csv");
	int fp = FileRead_open(filepath);
	while (FileRead_getc(fp) != '\n');
...
void SceneGameExtra::loadBossEventCSV(bool isStartEvent){
	char filepath[64];
	if (isStartEvent == true) sprintf_s(filepath, "material\\boss_talk\\s7.csv");
	else sprintf_s(filepath, "material\\boss_talk\\e7.csv");
...
void SceneGameExtra::isetNextStage(){
	Picture::deletePicture();
	...
	if (this->isetGameClearData->igetNoContinueFlag() == true){
		this->isetGameClearData->isetStageEXClearData(this->selectedMode);
	}
	this->isetGameClearData->isetNoContinueFlag(true);
}

bool SceneGameExtra::isHitPointSquare(Point p_point, Point sq_center, Size sq_size){
...
bool SceneGameExtra::isHitPointCircle(Point p_point, Point ci_center, double r){
...
bool SceneGameExtra::isHitSquareSquare(Point center1, Size size1, Point center2, Size size2){
...
bool SceneGameExtra::isHitCircleCircle(Point center1, double r1, Point center2, double r2){
...
void SceneGameExtra::hitCheckAllObject_Explode(){
	//プレイヤーと敵
...
void SceneGameExtra::hitCheckAllObject_Stand(){
	//プレイヤーと敵
	for (int i = 0; i<this->enemyManage->getEnemyVectorSizeMax(); i++){
		if (this->isHitPointSquare(this->player->getPosition(), this->enemyManage->getEnemyPosition(i)->igetPosition(), this->enemyManage->getEnemySize(i)) == true){
			if (this->player->getCharactorStatus() == ChStatus_Normal) {
...
void SceneGameExtra::hitCheckAllObject_Absorb(){
	//プレイヤーと敵
	for (int i = 0; i < this->enemyManage->getEnemyVectorSizeMax(); i++){
		if (this->isHitPointSquare(this->player->getPosition(), this->enemyManage->getEnemyPosition(i)->igetPosition(), this->enemyManage->getEnemySize(i)) == true){
			if (this->player->getCharactorStatus() == ChStatus_Normal) {
